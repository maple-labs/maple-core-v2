...
import { IERC20Like, IMapleGlobalsLike, IMapleLoanLike, IPoolLike, IPoolV2Like } from "../simulations/mainnet/Interfaces.sol";
...
contract Playground is SimulationBase {
    ...
    function run() external {
        ...
        //     console.log("lpVal ", IPoolV2Like(pool).convertToAssets(IPoolLike(pool).balanceOf(mavenUsdcLps[i])));
        // }
        ...
        // IMapleGlobalsLike(mapleGlobals).activatePoolManager(poolManager);
