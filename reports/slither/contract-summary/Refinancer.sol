...
+ Contract Refinancer (Most derived contract)
  - From MapleLoanInternals
    - _acceptNewTerms(address,uint256,bytes[]) (internal)
    - _claimFunds(uint256,address) (internal)
    - _clearLoanAccounting() (internal)
  ...
  - From SlotManipulatable
    ...
    - _setSlotValue(bytes32,bytes32) (internal)
  - From Refinancer
    - increasePrincipal(uint256) (external)
    - setCollateralRequired(uint256) (external)
    - setEarlyFeeRate(uint256) (external)
    - setEndingPrincipal(uint256) (external)
    - setGracePeriod(uint256) (external)
    - setInterestRate(uint256) (external)
    - setLateFeeRate(uint256) (external)
    - setLateInterestPremium(uint256) (external)
    - setPaymentInterval(uint256) (external)
    - setPaymentsRemaining(uint256) (external)
