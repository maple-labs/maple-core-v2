...
+ Contract MapleLoanInitializer (Most derived contract)
  ...
  - From MapleLoanInitializer
    - decodeArguments(bytes) (public)
    - encodeArguments(address,address[2],uint256[3],uint256[3],uint256[4]) (external)
    - fallback() (external)
